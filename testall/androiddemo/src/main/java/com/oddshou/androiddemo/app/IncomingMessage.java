...
package com.oddshou.androiddemo.app;
...
public class IncomingMessage extends Activity {
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        intents[0] = Intent.makeRestartActivityTask(new ComponentName(context,
                com.oddshou.androiddemo.ApiDemos.class));

        // "App"
        intents[1] = new Intent(context, com.oddshou.androiddemo.ApiDemos.class);
        intents[1].putExtra("com.oddshou.androiddemo.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(context, com.oddshou.androiddemo.ApiDemos.class);
        intents[2].putExtra("com.oddshou.androiddemo.Path", "App/Notification");
