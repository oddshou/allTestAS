...
package com.oddshou.androiddemo.os;
...
public class SmsMessagingDemo extends Activity {
    ...
    public static final String SMS_RECIPIENT_EXTRA = "com.oddshou.androiddemo.os.SMS_RECIPIENT";

    public static final String ACTION_SMS_SENT = "com.oddshou.androiddemo.os.SMS_SENT_ACTION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ComponentName componentName = new ComponentName("com.oddshou.androiddemo",
                "com.oddshou.androiddemo.os.SmsMessageReceiver");
