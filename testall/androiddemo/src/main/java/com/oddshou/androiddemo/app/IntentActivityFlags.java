...
public class IntentActivityFlags extends Activity {
    ...
    private Intent[] buildIntentsToViewsLists() {
        ...
        intent.setClass(IntentActivityFlags.this, com.oddshou.androiddemo.ApiDemos.class);
        intent.putExtra("com.oddshou.androiddemo.Path", "Views");
        intents[1] = intent;

        intent = new Intent(Intent.ACTION_MAIN);
        intent.setClass(IntentActivityFlags.this, com.oddshou.androiddemo.ApiDemos.class);
        intent.putExtra("com.oddshou.androiddemo.Path", "Views/Lists");
