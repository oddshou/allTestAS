...
package com.oddshou.testall.graaphics;
...
//                canvas.drawBitmap(mDstB, 0, 0, paint);
                canvas.drawOval(new RectF(0, 0, W*3/4, H*3/4), mDstPaint);
                paint.setXfermode(sModes[i]);
                canvas.drawBitmap(mSrcB, 0, 0, paint);
                paint.setColor(Color.RED);
                canvas.drawLine(x, y, x+W, x + H, paint);
//                canvas.drawRect(W/3, H/3, W*19/20, H*19/20, mSrcpaint);
